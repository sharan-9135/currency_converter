...
const ConverterForm = () => {
    ...
    const getExchangeRate = async () => {
        const API_KEY = "55674a6cdaa2d28ea9fe8a0d"; // Replace with your actual API key
        ...
        try {
            ...
            if (!response.ok) throw new Error("Something went wrong with the network request!");
    ...
    useEffect(() => {
        getExchangeRate();
    }, [fromCurrency, toCurrency]); // Added dependencies to fetch the rate when currencies change
